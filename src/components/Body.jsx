  ...
  return (
    <>
        ...
        <div className='container flex flex-col justify-center tablet:order-2 md:order-1 p-2 items-center md:items-start tablet:items-center'>
            ...
            <p data-aos="flip-up"  data-aos-duration="3000" className='w-4/5 text-center leading-6 font-sans md:w-full md:text-left md:text-lg tablet:text-center'>Sou desenvolvedor Web há mais de 1 ano, tenho conhecimento nas tecnológias HTML, CSS, JavaScript, TypeScript, React.Js, TailwindCss, Node.Js, Bootstrap e Python.</p>
