      ...
      <main className="mt-20 text:black dark:text-white font-mono w-4/5 mx-auto duration-1000">
        <section className="md:flex md:w-full md:justify-center md:mt-24 md:items-center tablet:flex-col">
          ...
          <div className="container flex flex-col justify-center tablet:order-2 md:order-1 p-2 items-center md:items-start tablet:items-center">
            ...
            <p data-aos="flip-up" data-aos-duration="3000" className="w-4/5 text-center leading-6 font-sans md:w-full md:text-left md:text-lg tablet:text-center">Desenvolvedor Web apaixonado em transformar conceitos em interfaces interativas e responsivas. Possuo sólidos conhecimentos nas tecnologias HTML, CSS, JavaScript, TypeScript, React.js, TailwindCss, Node.js, Bootstrap e Python.</p>
